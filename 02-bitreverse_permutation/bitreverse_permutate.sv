...
module bitreverse_pingpong #(
    ...
    function automatic logic [MAX_BLOCK_SIZE_LOG2-1:0] bitrev(
        input logic [MAX_BLOCK_SIZE_LOG2-1:0] value,
        input int width
    );
        logic [MAX_BLOCK_SIZE_LOG2-1:0] result = '0;
